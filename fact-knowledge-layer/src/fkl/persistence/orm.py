...
class DocumentORM(Base):
    ...
    canonical_entity: Mapped[str | None] = mapped_column(Text)
...
class IngestionRunORM(Base):
    ...
    insufficient_context_count: Mapped[int] = mapped_column(Integer, default=0)
    blocks_skipped_due_to_cap: Mapped[int] = mapped_column(Integer, default=0)

    # Coverage statistics (Task 9)
    prose_blocks_total: Mapped[int] = mapped_column(Integer, default=0)
    prose_blocks_llm_called: Mapped[int] = mapped_column(Integer, default=0)
    table_cells_total: Mapped[int] = mapped_column(Integer, default=0)
    table_cells_rejected_missing_header: Mapped[int] = mapped_column(Integer, default=0)
    table_cells_rejected_not_numeric: Mapped[int] = mapped_column(Integer, default=0)
    relationship_pairs_total: Mapped[int] = mapped_column(Integer, default=0)
...
class FactORM(Base):
    ...
    entity_canonical: Mapped[str | None] = mapped_column(Text)
